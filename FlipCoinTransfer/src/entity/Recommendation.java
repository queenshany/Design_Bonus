...
public class Recommendation {
	...
	public Recommendation(int recNum, Date creationDate, double probability, double recommendedFee, boolean isApproved) {
		this.recNum = recNum;
	...
	public String toString() {
		return "Recommendation Num: " + recNum + " | Creation Date: " + creationDate + " | Probability: " + probability
				+ " | Recommended Fee: " + recommendedFee + " | Is Approved: " + isApproved;
	}
}
